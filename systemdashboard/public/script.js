...
fetch("data.json").then(response => response.json()).then(data => {
  new gridjs.Grid({
    columns: [{id: "in_app", name: "Partner Application"},
    {id: "in_delivery", name: "Delivery", formatter: (_, row) => gridjs.html(`<div class="${row.cells[1].data}"><span class="detail">${row.cells[2].data}</span></div>`)},
    {id: "detail1", hidden: true},
    {id: "in_process", name: "Process", formatter: (_, row) => gridjs.html(`<div class="${row.cells[3].data}"><span class="detail">${row.cells[4].data}</span></div>`)},
    {id: "detail2", hidden: true},
    {id: "out_app", name: "Partner Application"},
    {id: "out_delivery", name: "Delivery", formatter: (_, row) => gridjs.html(`<div class="${row.cells[6].data}"><span class="detail">${row.cells[7].data}</span></div>`)},
    {id: "detail3", hidden: true}],
    pagination:true,
    data: data
